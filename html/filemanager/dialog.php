...
<!-- New div for Tesla Dashcam: uploadingoverlay div start -->
<div id="uploadingoverlay">
	<img src="/filemanager/img/spinner.gif" alt="Uploading">
	<h3>Upload in progress... please wait!</h3>
</div>
...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		...
		<!--		<button class="tip btn .multiple-upload-btn" title="<?php echo trans('Upload_all_to_drive');?>"><i class="icon-upload"></i></button>
...
?>
			...
			<figure data-name="<?php echo $file ?>" data-path="<?php echo $rfm_subfolder.$subdir.$file;?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
					<form action="sync_drive.php" method="post" class="download-form" id="form<?php echo $nu;?>">
					...
					<a title="<?php echo trans('Upload_to_drive');?>" class="tip-right" href="javascript:void('')"
					<?php if ($config['download_files']) echo " onclick=\"uploadingOverlay(); $('#form".$nu."').submit();\""; ?>>
						<i class='icon-upload <?php if(!$config['download_files']) echo ' icon-white'; ?>'></i>
				...
				<!--	<a class="preview disabled"><i class="icon-eye-open icon-white"></i></a> -->
					...
					<a href="javascript:void('')" class="tip-left edit-button rename-file-paths <?php if($config['rename_files'] && !$file_prevent_rename) echo "rename-file";?>" title="<?php echo trans('Rename')?>" data-folder="0" data-permissions="<?php echo $file_array['permissions']; ?>">
						<i class='icon-pencil <?php if(!$config['rename_files'] || $file_prevent_rename) echo ' icon-white'; ?>'></i>
					</a>
